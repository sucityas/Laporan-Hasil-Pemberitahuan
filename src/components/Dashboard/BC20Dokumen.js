...
class BC20Dokumen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            iframeTableau: ""
    ...
    componentDidMount() {
        axios.get(process.env.REACT_APP_SCE_WS + `/tableau/get-token`, {headers: {
            ...
            .then(res => {
                ...
                const urlTableau  = 'https://analytics2.customs.go.id/views/DashboardBC20Dokumen/DASHBOARDBC20DOKUMEN';
                this.setState({
    ...
    render() {
        return (
            <div>
                <SubHeader subHeaderTitle="Dashboard Nasional" breadcrumbs="Dashboard BC 2.0 Dokumen"/>
