...
class BC30Dokumen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            iframeTableau: ""
    ...
    componentDidMount() {
        axios.get(process.env.REACT_APP_SCE_WS + `/tableau/get-token`, {headers: {
            ...
            .then(res => {
                ...
                const urlTableau  = 'https://analytics2.customs.go.id/views/DashboardBC30Dokumen/DASHBOARDBC30DOKUMEN';
                this.setState({
    ...
    render() {
        return (
            <div>
                <SubHeader subHeaderTitle="Dashboard Nasional" breadcrumbs="Dashboard BC 3.0 Dokumen"/>
