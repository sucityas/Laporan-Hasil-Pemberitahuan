...
class BC40 extends Component {
    ...
    componentDidMount() {
        axios.get(process.env.REACT_APP_SCE_WS + `/tableau/get-token`, {headers: {
            ...
            .then(res => {
                ...
                const urlTableau  = 'https://analytics2.customs.go.id/views/DashboardBC40/DashboardBC40';
                this.setState({
    ...
    render() {
        return (
            <div>
                <SubHeader subHeaderTitle="Dashboard Nasional" breadcrumbs="Dashboard BC 4.0"/>
