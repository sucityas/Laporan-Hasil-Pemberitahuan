...
class CNDokumen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            iframeTableau: ""
    ...
    componentDidMount() {
        axios.get(process.env.REACT_APP_SCE_WS + `/tableau/get-token`, {headers: {
            ...
            .then(res => {
                ...
                const urlTableau  = 'https://analytics2.customs.go.id/views/DashboardBarkirDokumen/DashboardCN';
                this.setState({
    ...
    render() {
        return (
            <div>
                <SubHeader subHeaderTitle="Dashboard Nasional" breadcrumbs="Dashboard CN Dokumen"/>
