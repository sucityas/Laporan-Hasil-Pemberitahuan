...
class PpnLampA1Table extends Component {
    componentDidMount() {
        let options = {
        ...
        return (
            <div>
                ...
                >
                    ...
                    <Column caption={'No Dokumen'} dataField={'noDokumen'}/>
                    <Column caption={'Tanggal Dokumen'} dataField={'tglDokumen'}/>
                    <Column caption={'DPP'} dataField={'dpp'}/>
                    <Column caption={'Keterangan'} dataField={'ket'}/>
                </DataGrid>
            </div>
        );
    }
...
const store =  new CustomStore({
    load: function (loadOptions) {
        ...
        if (loadOptions.filter) {
            ...
            return axios.get(process.env.REACT_APP_SCE_WS + `/pajak/ppn-lamp-a1/list-paging${params}`, {
                    headers: {
