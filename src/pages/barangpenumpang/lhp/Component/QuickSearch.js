    ...
    render() {
        return (
            <div style={{position: 'relative'}}>
                <Input.Search allowClear placeholder={`${this.state.placeholder}`} value={this.state.keyword} onFocus={this.asyncFirst} onChange={this.inputListen}/>
                {this.state.data ? this.searcBox() : null}
            </div>
        );
    }
