...
class DataIzinDetail extends Component {
            ...
            if (!err) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        tdHeader.kodeNegaraLainnya = values.kodeNegaraKeterangan !== null ? (values.kodeNegaraKeterangan.toUpperCase().indexOf("TAIWAN") >= 0 ? "TW" : null) : null
                        tdHeader.kodeNegaraAsalKeterangan = values.kodeNegaraAsalKeterangan
                        tdHeader.kodeNegaraTujuanKeterangan = values.kodeNegaraTujuanKeterangan
                        tdHeader.kodeNegaraTujuanLainnya = values.kodeNegaraTujuanKeterangan !== null ? (values.kodeNegaraTujuanKeterangan.toUpperCase().indexOf("TAIWAN") >= 0 ? "TW" : null) : null
    ...
    editDataBatal() {
        ...
        this.props.form.setFieldsValue({
            ...
            kodeNegaraLainnya: this.state.dataDokumen.header.kodeNegaraLainnya,
            kodeNegaraAsalKeterangan: this.state.dataDokumen.header.kodeNegaraAsalKeterangan,
            kodeNegaraAsalLainnya: this.state.dataDokumen.header.kodeNegaraAsalLainnya,
            kodeNegaraTujuanKeterangan: this.state.dataDokumen.header.kodeNegaraTujuanKeterangan,
            kodeNegaraTujuanLainnya: this.state.dataDokumen.header.kodeNegaraTujuanLainnya,
                        ...
                        <div className="kt-section kt-section--first">
                            <div className="kt-section__body">
                                ...
                                <Form.Item label="Kebangsaan (jika Others)" style={{ marginTop: -20 }}>
                                    {getFieldDecorator('kodeNegaraKeterangan')(<Input readOnly={this.state.readOnly} placeholder="Keterangan" disabled={this.state.readOnly} />)}
                                </Form.Item>
                        ...
                        <div className="kt-section kt-section--first">
                            <div className="kt-section__body">
                                ...
                                <Form.Item label="Negara Tujuan (jika Others)" style={{ marginTop: -20 }}>
                                    {getFieldDecorator('kodeNegaraTujuanKeterangan')(<Input placeholder="Keterangan" readOnly={this.state.readOnly} disabled={this.state.readOnly} />)}
                                </Form.Item>
