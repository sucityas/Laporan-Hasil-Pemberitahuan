...
import DetailBarangBC22 from "./TabsDetailPemeriksaan/DetailBarangBC22";
...
// import InstruksiPemeriksaan from "../penelitian/periksaFisik/instruksiPemeriksaan";
/* PAGE */
...
class LhpDetailPemeriksaan extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    // console.log("Detail Pemeriksaan Update: ", this.state.dataDokumen)
  ...
  previewFoto() {
    ...
    this.setState({
      loading: true,
      loadingPhoto: this.state.hasilFotoLhp !== undefined && this.state.hasilFotoLhp.size > 0 ? true : false
    });
  ...
  async KirimData() {
    ...
    let kodeKategoriBarang = this.detailBarang.current.state.kodeKategoriBarang
    let kodeMataUang = this.detailBarang.current.state.kodeMataUang
    let jumlahHarga = this.detailBarang.current.state.jumlahHarga
    let nomorDokumenIzin = this.detailBarang.current.state.nomorDokumenIzin
    let tanggalDokumenIzin = this.detailBarang.current.state.tanggalDokumenIzin
    let merk = this.detailBarang.current.state.merk
    let tipe = this.detailBarang.current.state.tipe
    let ram = this.detailBarang.current.state.ram
    let kapasitas = this.detailBarang.current.state.kapasitas
    let warna = this.detailBarang.current.state.warna
    let npwp = this.detailBarang.current.state.npwp
    let imei1 = this.detailBarang.current.state.imei1
    let imei2 = this.detailBarang.current.state.imei2
    let validImei1 = this.detailBarang.current.state.validImei1
    let validImei2 = this.detailBarang.current.state.validImei2
    let kesesuaianBarang = this.state.kesesuaianBarang
    let keteranganTambahan = this.state.keteranganTambahan

    // console.log(kodeKategoriBarang)
    // console.log(uraian)
    // console.log(this.detailBarang.current.state)
    // console.log("dataTableDetail : ", this.state.dataTableDetail)

    let checkedBarang = true
    let checkedKesimpulan = false
    let checkedFoto = false

    if (kodeKategoriBarang === "" || kodeKategoriBarang === null || kodeKategoriBarang === undefined) {
      this.setState({
        requiredDetail: true
      })
      checkedBarang = false
    }
    else if (kodeKategoriBarang === '1') {
      if (uraian === "" || uraian === null || uraian === undefined || jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined || kodeSatuanBarang === "" || kodeSatuanBarang === null || kodeSatuanBarang === undefined || this.detailBarang.current.state.kategoriKarantina === "" || this.detailBarang.current.state.kategoriKarantina === null || this.detailBarang.current.state.kategoriKarantina === undefined) {
        this.setState({
          requiredDetail: true
        })
        checkedBarang = false
    ...
    else if (kodeKategoriBarang === '2') {
      if (uraian === "" || uraian === null || uraian === undefined || jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined || kodeSatuanBarang === "" || kodeSatuanBarang === null || kodeSatuanBarang === undefined) {
        this.setState({
          requiredDetail: true
        })
        checkedBarang = false
    ...
    else if (kodeKategoriBarang === '3' || kodeKategoriBarang === '4') {
      if (uraian === "" || uraian === null || uraian === undefined || kodeMataUang === "" || kodeMataUang === null || kodeMataUang === undefined) {
        this.setState({
          requiredDetail: true
        })
        checkedBarang = false
    ...
    else if (kodeKategoriBarang === '6' || kodeKategoriBarang === '7') {
      if (uraian === "" || uraian === null || uraian === undefined || jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined || kodeSatuanBarang === "" || kodeSatuanBarang === null || kodeSatuanBarang === undefined) {
        this.setState({
          requiredDetail: true
        })
    ...
    else if (kodeKategoriBarang === '8') {
      if (nomorDokumenIzin === "" || nomorDokumenIzin === null || nomorDokumenIzin === undefined || tanggalDokumenIzin === "" || tanggalDokumenIzin === null || tanggalDokumenIzin === undefined || uraian === "" || uraian === null || uraian === undefined || jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined || kodeSatuanBarang === "" || kodeSatuanBarang === null || kodeSatuanBarang === undefined) {
        this.setState({
          requiredDetail: true
        })
        checkedBarang = false
    ...
    // else if (kodeKategoriBarang === '9') {
    //     if (uraian === "" || uraian === null || uraian === undefined || merk === "" || merk === null || merk === undefined || tipe === "" || tipe === null || tipe === undefined || ram === "" || ram === null || ram === undefined
    //         || kapasitas === "" || kapasitas === null || kapasitas === undefined || warna === "" || warna === null || warna === undefined || imei1 === "" || imei1 === null || imei1 === undefined || imei2 === "" || imei2 === null || imei2 === undefined
    //         || kodeMataUang === "" || kodeMataUang === null || kodeMataUang === undefined || jumlahHarga === "" || jumlahHarga === null || jumlahHarga === undefined) {
    //         this.setState({
    //             requiredDetail: true
    //         })
    //     }
    ...
    // ram, kapasitas, warna
      ...
      if (uraian === "" || uraian === null || uraian === undefined || merk === "" || merk === null || merk === undefined || tipe === "" || tipe === null || tipe === undefined
        || imei1 === "" || imei1 === null || imei1 === undefined || jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined || kodeSatuanBarang === "" || kodeSatuanBarang === null || kodeSatuanBarang === undefined
        || validImei1 === false || (validImei2 === false && imei2 !== "")
      ) {
        this.setState({
          requiredDetail: true
        })
    ...
    // if (this.detailBarang.current.state.pernyataanLartas === "" || this.detailBarang.current.state.pernyataanLartas === null || this.detailBarang.current.state.pernyataanLartas === undefined) {
    //   this.setState({
    //     requiredDetail: true
    //   })
    // } else {
    ...
    // }
    checkedKesimpulan = true
    // Khusus BC 2.2, foto tidak mandatory
    checkedFoto = true
    ...
    if (checkedFoto && checkedKesimpulan && checkedBarang) {
      ...
      tdLhpDetail.idLhp = this.detailBarang.current.state.idLhp
      tdLhpDetail.idHeader = this.detailBarang.current.state.idHeader
      ...
      tdLhpDetail.ram = this.detailBarang.current.state.ram
      tdLhpDetail.kapasitas = this.detailBarang.current.state.kapasitas
      tdLhpDetail.warna = this.detailBarang.current.state.warna
      tdLhpDetail.idPemilik = this.detailBarang.current.state.idPemilik
      tdLhpDetail.imei1 = this.detailBarang.current.state.imei1
      tdLhpDetail.imei2 = this.detailBarang.current.state.imei2
      tdLhpDetail.npwp = this.detailBarang.current.state.npwp
      tdLhpDetail.nomorDokumenIzin = this.detailBarang.current.state.nomorDokumenIzin
      tdLhpDetail.tanggalDokumenIzin = this.detailBarang.current.state.tanggalDokumenIzin
      ...
      tdLhpDetail.kodeKategoriBarang = this.detailBarang.current.state.kodeKategoriBarang
      tdLhpDetail.kategoriKarantina = this.detailBarang.current.state.kategoriKarantina
      tdLhpDetail.kesesuaianBarang = this.state.kesesuaianBarang
      tdLhpDetail.keteranganTambahan = this.state.keteranganTambahan
      tdLhpDetail.pernyataanLartas = this.detailBarang.current.state.pernyataanLartas
      tdLhpDetail.posTarif = this.detailBarang.current.state.posTarif
      tdLhpDetail.flagTidakBersamaan = this.detailBarang.current.state.flagTidakBersamaan
      tdLhpDetail.flagLostAndFound = this.detailBarang.current.state.flagLostAndFound
      tdLhpDetail.flagManifes = this.detailBarang.current.state.flagManifes
        ...
        .then((result) => {
          if (result.value) {
            if (!(this.state.dataTableDetail === null && this.state.dataTableDetail === undefined || this.state.dataTableDetail.length === 0)) {
              ...
              tdLhp.tanggalLhp = this.state.dataDokumen != null ? (this.state.dataDokumen.tdLhp !== null ? this.state.dataDokumen.tdLhp.tanggalLhp : moment().format('YYYY-MM-DD HH:mm:ss')) : moment().format('YYYY-MM-DD HH:mm:ss')
        ...
        <div className="kt-portlet__body">
          <div className="kt-section kt-section--last">
            <Card>
              <Row gutter={8} className="mb-2" type="flex" justify="end">
                <Col type="flex" justify="start">
                  <button className="btn btn-warning btn-sm" onClick={this.modalIp}>
                    <span style={{ fontWeight: "bold" }}>IP</span>
                  </button>
                </Col>
                <Col type="flex" justify="start">
                  <button className="btn btn-warning btn-sm" onClick={this.handleBAP}>
                    <span style={{ fontWeight: "bold" }}>BAP</span>
                  </button>
                </Col>
                <Col>
                  <Popover placement="top" content={"Simpan data sebagai Draft"} trigger="hover" >
                    <button className="btn btn-info btn-sm" onClick={this.handleSimpan}>
                      <i className="fa fa-save" /> &nbsp; Simpan Draft
                    </button>
                  </Popover>
                </Col>
                <Col>
                  <Popover placement="top" content={"LHP yang telah selesai tidak dapat diubah"} trigger="hover">
                    <button className="btn btn-success btn-sm" disabled={this.state.janganKirim} onClick={this.handleSubmit}>
                      <i className="fa fa-paper-plane" /> &nbsp; Selesai
                    </button>
                  </Popover>
                </Col>
              </Row>
                ...
                <Row className="mb-2" gutter={8}>
                  ...
                  <Col span={18}>
                    <Radio.Group value={this.state.kesimpulanPemeriksaan}
                      onChange={e => { this.setState({ kesimpulanPemeriksaan: e.target.value }); }}
                    >
                      <Radio value={'S'}>Sesuai</Radio>
                      <Radio value={'T'}>Tidak Sesuai</Radio>
                      <Radio value={'L'}>Lain-lain</Radio>
                    </Radio.Group>
                  </Col>
                </Row>
                <Row className="mb-2" gutter={8}>
            ...
            <Card>
              <Row gutter={8} className="mb-2" type="flex" justify="end">
                <Col>
                  <button className="btn btn-primary" onClick={this.tambahbarang}>
              ...
              <div className="kt-portlet">
                <div className="kt-portlet__body">
                  ...
                  >
                    ...
                    <Column title="Merk" dataIndex="tdLhpDetail.merk" key="merk" />
                    ...
                    <Column title="Nilai" dataIndex="tdLhpDetail.jumlahHarga" key="jumlahHarga" />
                    <Column
                      title="Aksi"
                      key="status"
                      width={"180px"}
                      render={(record) => (
                        <div>
                          ...
                          {record.tdLhpDetail.flagPenetapan !== "Y" ? (
                            <Fragment>
                              &nbsp;
                      ...
                      <Row className="mb-2" gutter={8}>
                        <Col span={24}>
                          <DetailBarangBC22
                            ...
                            readOnlyTambahBarang={this.state.readOnlyTambahBarang}
                                ...
                                <Row gutter={8} style={{ margin: "5px" }}>
                                  ...
                                  <Col span={18}>
                                    <Radio.Group
                                      ...
                                      disabled={this.state.readOnlyHasil}
                        ...
                        <Col span={24}>
                          <div id={this.state.requiredDetailFoto === true ? "error" : ""}>
                            <Card title="Foto LHP Barang">
                              <Spin spinning={this.state.loadingPhoto} size="large">
                                <p className={'text-red'} style={{ fontSize: '12px' }}>&nbsp; Maksimal 2 foto per barang</p>
                                {!this.state.readOnlyHasil ? (
                                  <button className="btn btn-success" onClick={this.modalUploadUtama} disabled={this.state.hasilFotoLhp.length >= 2}>
                                    <i className="fa fa-upload" /> &nbsp; Tambah Foto Barang
                                  </button>
                                ) : null}
                                <br />
                                <br />
                                ...
                                {this.state.dataFotoCoba.map(
                                  (item, key) => (
                                    <span key={key} style={{ width: '100%', display: 'inline', position: 'relative', }}>
                                      {/* <Spin spinning={this.state.loaded} size="small"> */}
                                      <img
                                        alt="example"
                                        src={item.data}
                                ...
                                >
                                  ...
                                  <Form.Item label="Keterangan">
                                    <TextArea
                                      ...
                                      placeholder="Diisi dengan keterangan barang"
                                      onChange={(e) =>
                                        this.setState({
            ...
            <Modal
              visible={this.state.visibleBap2}
            ...
            >
              <PDFViewer
                idLhp={this.state.idLhp} reload={this.state.reload}
              />
            </Modal>
            ...
            <Modal
              visible={this.state.modalIp}
              title={<Fragment><span>Instruksi Pemeriksaan</span>
                {/* <button className="btn btn-success btn-sm" style={{ float: 'right' }} onClick={this.modalRekamIp}>
                                    <i className="fa fa-plus" /> &nbsp; Rekam IP
                                </button> */}
              </Fragment>}
              width="80%"
              onCancel={this.closeModalIp}
              onOk={this.closeModalIp}
              closable={false}
            >
              {/* <InstruksiPemeriksaan
                idLhp={this.state.idLhp} reload={this.state.reload} flagIp={true}
              /> */}
            </Modal>
          </div>
        </div>
