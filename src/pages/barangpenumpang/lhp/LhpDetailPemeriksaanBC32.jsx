...
import DetailBarangBC32 from "./TabsDetailPemeriksaan/DetailBarangBC32";
...
class LhpDetailPemeriksaan extends React.Component {
    ...
    async KirimData() {
        ...
        if (jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined) {
            ...
            checkedBarang = false
        } else if (this.detailBarang.current.state.pernyataanLartas === "" || this.detailBarang.current.state.pernyataanLartas === null || this.detailBarang.current.state.pernyataanLartas === undefined) {
            this.setState({
                requiredDetail: true
            })
            checkedBarang = false
                    ...
                    <div className="kt-section kt-section--last">
                        <Card>
                            <Row gutter={8} className="mb-2" type="flex" justify="end">
                                <Col type="flex" justify="start">
                                    {/* <Button type="primary" disabled={this.state.janganKirim} onClick={this.handleBAP}>
                                        <Icon type="save" />
                                ...
                                <Col>
                                    ...
                                    {/* <button className="btn btn-info btn-sm" onClick={this.handleSimpan}>
                                        <i className="fa fa-save" /> &nbsp; Simpan LHP
                                    </button> */}
                                ...
                                <Col>
                                    ...
                                    {/* <button className="btn btn-success btn-sm" disabled={this.state.janganKirim} onClick={this.handleSubmit}>
                                        <i className="fa fa-paper-plane" /> &nbsp; Kirim LHP
                                    </button> */}
                                ...
                                {/* <Col>
                                    <button className="btn btn-danger btn-sm" onClick={this.batal}>
                                        <i className="fa fa-ban" /> &nbsp; Kembali
                                    </button>
                                </Col> */}
                            </Row>
                        </Card>
                        ...
                        <Card>
                            <Row gutter={8} className="mb-2" type="flex" justify="end">
                                <Col>
                                    {/* {is_readonly && ( */}
                                    {/* <Button onClick={this.tambahbarang} type="primary">
