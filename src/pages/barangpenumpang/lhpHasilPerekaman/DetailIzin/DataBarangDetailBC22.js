...
import RekamBarang from "./RekamBarangBC22";
...
class DataBarangBC22 extends Component {
                    ...
                    if (result.value) {
                        ...
                        if (this.state.deleteBarang.length !== 0) {
                            ...
                            for (let i = 0; i < this.state.deleteBarang.length; i++) {
                                ...
                                if (!(this.state.deleteBarang[i].idDetail === null || this.state.deleteBarang[i].idDetail === undefined)) {
        ...
        return (
            ...
            <div>
                <div class="kt-portlet__head">
                    ...
                    {/* <Button type="primary" htmlType="submit" onClick={this.handleRekam.bind(this)}>
                        Rekam Barang
                    </Button> */}
                </div>
                {/* <Table
                        // loading={this.state.loading}
                        dataSource={this.state.dataRekam}
                        pagination={{ pageSize: 10 }}
                    >

                        <Column title="No." dataIndex="nomor" key="nomor" render = {(value, item, index) => index + 1}/>
                        <Column title="Uraian" dataIndex="uraianBarang" key="uraianBarang" />
                        <Column title="Jumlah" dataIndex="jumlahSatuan" key="jumlahSatuan" />
                        <Column title="Pos Tarif" dataIndex="kodeHs" key="kodeHs" />
                    </Table> */}
                ...
                >
                    ...
                    <Column title="Kategori" dataIndex="kodeKategoriBarang" key="kodeKategoriBarang"
                    ...
                    <Column title="Merk" dataIndex="merk" key="merk" />
                    <Column title="Jumlah" dataIndex="jumlahSatuan" key="jumlahSatuan" />
                ...
                >
                    <RekamBarang
                        handleClear={this.handleClear} handleDataRekam={this.handleDataRekam} data={this.state.updateData} readOnly={this.state.readOnly} clear={this.state.clear} refBarang={this.state.dataReferensiKategori}
                    />
                    <div
                        style={{
                            position: 'absolute',
...
const WrappedDataBarang = Form.create()(DataBarangBC22);
