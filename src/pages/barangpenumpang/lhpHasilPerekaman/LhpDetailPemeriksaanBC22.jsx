...
class LhpDetailPemeriksaan extends React.Component {
    ...
    async KirimData() {
        ...
        if (kodeKategoriBarang === "" || kodeKategoriBarang === null || kodeKategoriBarang === undefined) {
            ...
            if (uraian === "" || uraian === null || uraian === undefined || jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined || kodeSatuanBarang === "" || kodeSatuanBarang === null || kodeSatuanBarang === undefined || kodeMataUang === "" || kodeMataUang === null || kodeMataUang === undefined) {
                this.setState({
                    requiredDetail: true
                })
                checkedBarang = false
            ...
            if (nomorDokumenIzin === "" || nomorDokumenIzin === null || nomorDokumenIzin === undefined || tanggalDokumenIzin === "" || tanggalDokumenIzin === null || tanggalDokumenIzin === undefined || uraian === "" || uraian === null || uraian === undefined || jumlahSatuan === "" || jumlahSatuan === null || jumlahSatuan === undefined || kodeSatuanBarang === "" || kodeSatuanBarang === null || kodeSatuanBarang === undefined || kodeMataUang === "" || kodeMataUang === null || kodeMataUang === undefined) {
                this.setState({
                    requiredDetail: true
                })
                checkedBarang = false
        ...
        // ram, kapasitas, warna
            ...
            if (uraian === "" || uraian === null || uraian === undefined || merk === "" || merk === null || merk === undefined || tipe === "" || tipe === null || tipe === undefined
                ...
                || kodeMataUang === "" || kodeMataUang === null || kodeMataUang === undefined) {
                this.setState({
                    requiredDetail: true
                })
                checkedBarang = false
                            ...
                            <Row className="mb-2" gutter={8}>
                                ...
                                <Col span={15}>
                                    <TextArea
                                        ...
                                        onChange={e => this.setState({ catatanKesimpulan: e.target.value })} readOnly
                                    />
                                </Col>
                            </Row>
