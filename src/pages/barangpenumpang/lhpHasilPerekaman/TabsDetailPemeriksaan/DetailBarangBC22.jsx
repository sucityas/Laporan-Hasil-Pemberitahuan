...
class DetailBarang extends Component {
    ...
    fetchReferensiPemilik = () => {
        ...
        const isLocalhost =
            window.location.host == "ceisa40.customs.go.id-prod";
        const res = axios.get(
            `${REACT_APP_API_BARANG_PENUMPANG}/table/entitas/keluarga/${idHeader}`,
            {
                headers: {
                    [!isLocalhost
                        ? "beacukai-api-key"
    ...
    fetchReferensiKategori = () => {
        ...
        const isLocalhost =
            window.location.host == "ceisa40.customs.go.id-prod";
        const res = axios.get(
            `${REACT_APP_API_BARANG_PENUMPANG}/cd/pernyataan-barang/list`,
            {
                headers: {
                    [!isLocalhost
                        ? "beacukai-api-key"
                    ...
                    >
                        <Form>
                            ...
                            <Fragment>
                                <Row gutter={8}>
                                    <Col span={4}>
                                        <p>Kode Valuta {this.state.kodeKategoriBarang !== "5" ? (<span style={{ color: 'red' }}>*</span>) : null}</p>
                                    </Col>
                                    <Col span={8}>
                                        <Select
                                ...
                                <Row gutter={8}>
                                    <Col span={4}>
                                        <p>Harga Satuan {this.state.kodeKategoriBarang !== "5" ? (<span style={{ color: 'red' }}>*</span>) : null}</p>
                                    </Col>
                                    <Col span={8}>
                                        <InputNumber
                                            pattern="[0-9]+[.0-9]*"
